...
async function loadFAQForLanguage(lang: string): Promise<void> {
  ...
  const extraEntries: FAQEntry[] = lang === 'fr' ? [
    ...
    { q: 'C\'est quoi ce cours ?', a: 'Le cours Agentic SaaS enseigne l\'orchestration multi-agents depuis les fondamentaux. Vous passez de la compréhension des tokens et fenêtres de contexte à la coordination de flottes d\'agents qui construisent des logiciels en production. 52 heures, 4 niveaux, 4 capstones.' },
