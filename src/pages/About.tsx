  ...
  return (
    <>
      <SEO
        ...
        keywords="charles jackson about, full stack developer experience, 20 years developer, montreal software engineer, tech lead, startup founder, predictive augure, nxsupabase creator"
        jsonLd={[
          {
            '@type': 'ProfilePage',
            mainEntity: {
